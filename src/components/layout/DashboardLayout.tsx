    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-slate-900/80 backdrop-blur border-b border-slate-800 px-6 flex items-center justify-between sticky top-0 z-20">
          <div>
            <h2 className="text-sm font-semibold text-slate-100">{pageTitle}</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="bg-slate-950 border border-slate-800 text-xs rounded-lg pl-9 pr-4 py-1.5 text-slate-200 placeholder:text-slate-400 focus:outline-none focus:border-brand-500 transition-colors w-64"
                readOnly
              />
            </div>
